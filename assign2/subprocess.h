 ...
 *   openfds: a set<int> of additional file descriptors known to be open in the parent that should be closed in the
 *            child process.  This set should never include file descriptors 0, 1, or 2.
 */
