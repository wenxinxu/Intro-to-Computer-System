...
var datePickerController = (function datePickerController() {
   ...
   function datePicker(options) {
           ...
           if (td) {
               try {
                   ...
                   if (!this.noFocus && !this.clickActivated) {
                       setTimeout(function () { try { td.focus(); } catch (err) { }; }, 200);
                   };
               } catch (err) { };
           };
       };
       ...
       this.create = function () {
           ...
           function createTHButton(details) {
               var th = document.createElement('th');
               if (details.thClassName) {
                   th.className = details.thClassName;
               };
           ...
           tr.setAttribute("class","fd-hidden-input");

           // Today Button
           this.todayButton = createTHButton({ className: "today-but", id: "-today-but",  text: "Today", title: getTitleTranslation(2) });
           tr.appendChild(this.todayButton);
...
//                       ]);
           ...
           // Prev Month Button
           this.prevButton = createTHButton({ className: "prev-but prev-month", id: "-prev-month-but", text: "\u2039", title: getTitleTranslation(4) });
           tr.appendChild(this.prevButton);
           
           // Title Bar
           this.titleBar = createTH({ thClassName: "date-picker-title" + dragEnabledCN, colspan: this.showWeeks ? 6 : 5 });
           ...
           // Next Month Button
           this.nextButton = createTHButton({ className: "next-but next-month", id: "-next-month-but", text: "\u203A", title: getTitleTranslation(2) });
           tr.appendChild(this.nextButton);
   ...
   datePicker.prototype.createButton = function () {
       ...
       fontIconHolder.className = "FontAwesome";
       fontIconHolder.style.fontFamily = "FontAwesome";
       fontIconHolder.innerHTML = '&#xf073;';
