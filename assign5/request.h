...
/***
 * Function: addRequestEntity
 * add request header entity and set to http
 * add request header entity set its value to ip
 */
  void addRequestEntity(const std::string& clientIPAddress);
 private:
